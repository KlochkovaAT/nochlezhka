...
if (categoryForm) {
  ...
  categoryForm.addEventListener('submit', (e) => {
    ...
    switch (currentChoice) {
      case 'cafe':
        location.href = './cafe-form.html';
        break;
      case 'master-class':
        location.href = './master-class-form.html';
        break;
      case 'party':
        location.href = './party-form.html';
        break;
      case 'other':
        location.href = './other-form.html';
        break;
    }
  });
}
...
function reversPageThanks () {
  location.href = "./pageThanksForBid.html";
}
pageThanks.addEventListener('click', reversPageThanks);
